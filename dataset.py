...
Data_Path = "/home/hong/torch/data"
...
def get_outliers_loader(args):
    ...
    if args.dataset == "fashion":
        ...
        dataset = torchvision.datasets.ImageFolder(root='../../dataset/tiny', transform=transform)
...
def get_loaders(args):
    ...
    elif args.dataset == "dogvscat":
        transform = transform_color
        trainset = ImageFolder(root = '../data/dogs-vs-cats/train/train/', transform=transform)
        testset = ImageFolder(root = '../data/dogs-vs-cats/train/test/', transform=transform)
